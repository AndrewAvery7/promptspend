/**
 * Scenario <-> URL serialization shared by the website and native apps.
 *
 * Pasted prompt text is deliberately never encoded. URLs can enter browser
 * history, analytics, referrer headers, messaging systems, and server logs.
 * Only derived token counts and explicit pricing assumptions may travel.
 */
