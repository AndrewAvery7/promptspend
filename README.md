...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-945-blue.svg" alt="945 tests">
...
Beyond the calculator, the build writes 161 crawlable pages — one per model, one per provider, and a
...
| [docs/TESTING.md](docs/TESTING.md)                     | What the 945 tests cover, the uneven coverage thresholds, and what the suite deliberately does not cover |
