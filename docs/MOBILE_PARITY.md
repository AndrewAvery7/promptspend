...
| Alert cadence, scope, followed models, and unsubscribe management | **Adapted** — the secure hosted alert-management flow preserves these outcomes              | Complete the full subscribe, preference, and unsubscribe handoff QA                                                                                                           |
