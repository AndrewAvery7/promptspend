...
| Multi-country model filtering    | **Partial** — live-catalog counts, multi-select country chips, combined search filtering, and explanatory empty states are implemented | Complete physical-device screen-reader, horizontal-scroll, and largest-text QA     |
...
| Multi-country catalog and Value Map filtering                  | **Partial** — one live-catalog-derived selection narrows and rescales both surfaces and repeats beside the long list | Complete physical-device chart, scrolling, and screen-reader QA  |
...
| Email price alerts                                                | **Adapted** — native subscribe and double-opt-in controls are implemented; Turnstile alone runs in an isolated, data-minimized WebView             | Hardened Worker version `6d85b14c-6a03-4926-8f61-0f62d4c33935` is live; complete real-email and physical-device QA                                                            |
...
| Alert cadence, scope, followed models, and unsubscribe management | **Adapted** — native controls use a short-lived emailed code rather than a password or website handoff; signed website preference links still work | Complete subscribe, verification-code, update, invalid/expired-code, and destructive-unsubscribe QA against the live hardened deployment                                      |
| Country filter for followed alert models                          | **Partial** — the native alert picker combines search with live-catalog multi-country filtering without clearing already followed models           | Complete real-service and physical VoiceOver/TalkBack QA                                                                                                                      |
...
| Privacy policy and support                                        | **Complete and deployed** — dedicated public pages and native links are live                                                                       | Complete browser, mail, and accessibility handoff QA on physical devices                                                                                                      |
