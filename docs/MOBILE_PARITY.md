...
| Email price alerts                                                | **Adapted** — native subscribe and double-opt-in controls are implemented; Turnstile alone runs in an isolated, data-minimized WebView             | Deploy the static Turnstile page, Worker migration, and endpoints; complete real-email and device QA                                                                          |
...
| Alert cadence, scope, followed models, and unsubscribe management | **Adapted** — native controls use a short-lived emailed code rather than a password or website handoff; signed website preference links still work | Deploy and complete the subscribe, verification-code, update, invalid/expired-code, and destructive-unsubscribe QA                                                            |
