...
> **Current private-QA binaries.** Android versionCode 10 is the current
...
- Android internal APK: version 0.1.0, versionCode 10, EAS build
  `957ed01e-a4c0-4285-82ef-5863e3d2ad06`; the verified artifact and checksum are
  recorded in `docs/qa/ANDROID_GALAXY_A15_BUILD_10.md`.
- Android 10 uses commit `c53e071e353c2be1c11f73640cc198ecd2254348`; the attempted
...
- `docs/qa/ANDROID_GALAXY_A15_BUILD_9.md` (superseded)
- `docs/qa/ANDROID_GALAXY_A15_BUILD_10.md`
