...
**1036 tests in all**: 445 unit and integration tests in this package, 115 in
`apps/mobile/`, 108 in `worker/`, 44 in `api/`, 47 in `mcp/`, 137 in `vscode/`,
and 140 browser tests across four viewports. Those seven figures are the whole suite and they sum to the
...
| Browser        | 140   | Layout and accessibility at 320/390/768/1280 in real Chromium — overflow, touch targets, text size, table scrolling, axe at WCAG 2.1 A/AA, plus the Receipt copy, outage, and machine-contract flows. See below.                                                                                                                                                                                                |
