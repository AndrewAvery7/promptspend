...
| `src/components/LaunchBanner.test.tsx` | 8     | The mobile-launch signup: that it posts to the launch endpoint rather than the price-alert one, that it never states a date, and that it degrades to an announcement when email is off.                                                                                                                                                                       |
