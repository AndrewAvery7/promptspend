...
| `src/lib/pricing/catalog.test.ts`     | 33    | Schema validation including every malformed case the pipeline could produce, alias handling, the two freshness dates, and the four states the results-panel chip can report.                                                                                                                                                                                  |
...
| -------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `worker/`      | 98    | The alerts API inside workerd against a real D1 — including the RFC 8291 push crypto, checked byte-for-byte against the worked example in the RFC itself.                                                                                                                                                                                                                                                       |
| `apps/mobile/` | 91    | The native launch product: all five route outcomes, private prompt conversion, pricing-cache resilience, state recovery, sharing privacy, accessibility contracts, alert requests, and the Turnstile message boundary.                                                                                                                                                                                          |
