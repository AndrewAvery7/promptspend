...
**785 tests in all**: 380 unit and integration tests in this package, 84 in
...
| `src/lib/seo/prose.test.ts`           | 8     | Frontmatter splitting and its failure modes, and that the markdown-to-HTML pass handles headings, bold, code spans, fenced blocks and escaping.                                                                                                                                                                                                               |
