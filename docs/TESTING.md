...
**568 tests in all**: 333 unit and integration tests in this package, 84 in
`worker/`, 29 in `api/`, 22 in `mcp/`, and 100 browser tests across four
...
| Browser   | 100   | Layout and accessibility at 320/390/768/1280 in real Chromium — overflow, touch targets, text size, table scrolling, axe at WCAG 2.1 A/AA. See below.                    |
