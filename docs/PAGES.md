...
from the same catalog and costed by the same engine as the app. 159 of them
today: 69 models, 12 providers, 75 comparisons, 3 indexes.
...
| `/models/<slug>/`      | 69    | Full rate card, three monthly bills, rank, alternatives, provenance |
...
The combinatorial answer is 69 × 68 ÷ 2 = 2,346 pages, nearly all comparing
