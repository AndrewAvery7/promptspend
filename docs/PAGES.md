...
today: 75 models, 12 providers, 71 comparisons, 3 indexes.
...
| `/models/<slug>/`      | 75    | Full rate card, three monthly bills, rank, alternatives, provenance |
...
The combinatorial answer is 75 × 74 ÷ 2 = 2,775 pages, nearly all comparing
