...
**Sending the mobile-launch announcement.** Resolved 2026-09-23 without being
built: the apps shipped, and the list held only the developer's own test
signup, so the list was closed and emptied instead. See the closed-list note in
[ALERTS.md](ALERTS.md).
