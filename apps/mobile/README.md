...
- Search covers every destination, models, comparison selection, appearance, the tour, and scenario reset. The six-step contextual tour navigates to and spotlights the real Home, Estimate, Compare, Learn, Data & Alerts, and global-tool surfaces rather than describing them over a static screen. Appearance persists System/Light/Dark, four accents, and cool/warm canvases on-device.
