...
- Data & Alerts shows pipeline health, public sync evidence, the trust ladder, flagged prices, commit-feed and repository options, secure hosted email-alert management, privacy and support resources, and API/MCP/editor integrations. Native push remains withheld until the alerts Worker supports APNs/FCM tokens; browser VAPID subscriptions cannot be reused by native apps.
