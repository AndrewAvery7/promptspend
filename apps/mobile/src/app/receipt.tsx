...
function createStyles(theme: MobileTheme) {
  return StyleSheet.create({
    ...
    receiptBrand: { color: '#2456E6', fontSize: 17, fontWeight: '900', letterSpacing: 0.4 },
    receiptEyebrow: { color: '#2456E6', fontSize: 8, fontWeight: '900', letterSpacing: 1.8, marginTop: 4 },
    ...
    differenceValue: { color: '#2456E6', fontSize: 22, fontWeight: '900', lineHeight: 26 },
